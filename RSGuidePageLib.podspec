#
# Be sure to run `pod lib lint RSGuidePageLib.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'Swift Package Guide Page.'
...
Swift implementation of the guide page package, support for multiple pictures and video guide page.
  ...
  s.homepage         = 'https://github.com/ReverseScale/RSGuidePageLib'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'ReverseScale' => 'reversescale@icloud.com' }
  s.source           = { :git => 'https://github.com/ReverseScale/RSGuidePageLib.git', :tag => s.version.to_s }
